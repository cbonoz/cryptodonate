...
// I exported these functions to make the CharitiesList component more readable.

export default {
    addListener(charity) {
        if(charity!==null){
            charity.addEventListener("mouseenter", setBackground);   
        }
    }
}

function setBackground(e) {
    // Variable assignments for data attributes from React refs in CharitiesList component.
